...
ActiveRecord::Schema[7.1].define(version: 2024_02_13_045846) do
  create_table "m_channels", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "m_users", charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.string "email"
  ...
  create_table "m_workspaces", charset: "utf8mb3", force: :cascade do |t|
    t.string "workspace_name"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  end

  create_table "t_direct_messages", charset: "utf8mb3", force: :cascade do |t|
    t.string "directmsg"
  ...
  create_table "t_direct_star_msgs", charset: "utf8mb3", force: :cascade do |t|
    t.integer "userid"
  ...
  create_table "t_direct_star_threads", charset: "utf8mb3", force: :cascade do |t|
    t.integer "userid"
  ...
  create_table "t_direct_threads", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "t_group_mention_msgs", charset: "utf8mb3", force: :cascade do |t|
    t.integer "userid"
  ...
  create_table "t_group_mention_threads", charset: "utf8mb3", force: :cascade do |t|
    t.integer "userid"
  ...
  create_table "t_group_messages", charset: "utf8mb3", force: :cascade do |t|
    t.string "groupmsg"
  ...
  create_table "t_group_star_msgs", charset: "utf8mb3", force: :cascade do |t|
    t.integer "userid"
    t.integer "groupmsgid"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "t_group_star_threads", charset: "utf8mb3", force: :cascade do |t|
    t.integer "userid"
    t.integer "groupthreadid"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "t_group_threads", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "t_user_channels", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "t_user_workspaces", charset: "utf8mb3", force: :cascade do |t|
    t.integer "userid"
